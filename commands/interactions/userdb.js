...
const modal = new ModalBuilder()
        ...
        .setCustomId('timezoneField').setPlaceholder('America/New_York').setMaxLength(42).setRequired(false).setStyle(TextInputStyle.Short).setLabel(`Your timezone (optional)`));
