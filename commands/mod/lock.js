...
class PingCommand extends Command {
  ...
  async messageRun(message, args) {
    ...
    if (all) {
        ...
        if (total == 0) return message.reply(`:x: No channels were set to lock. Use \`lockchannels\` to set them.`);
        ...
        await message.channel.permissionOverwrites
                ...
                .then(function () {
                  message.reply(`:white_check_mark: Successfully unlocked ${message.channel}.`);
                })
                .catch((err) => {
                  message.reply(`:x: ${err}`);
                });
        ...
        await message.channel.permissionOverwrites
                ...
                .then(function () {
                  message.reply(`:white_check_mark: Successfully locked ${message.channel}.`);
                })
                .catch((err) => {
                  message.reply(`:x: ${err}`);
                });
