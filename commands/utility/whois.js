...
const { ApplicationCommandType, EmbedBuilder, Colors, PermissionFlagsBits } = require('discord.js');
...
class UserCommand extends Command {
  ...
  async chatInputRun(interaction) {
    ...
    if (member) {
      ...
      const embed = new EmbedBuilder()
      .setAuthor({ name: user.displayName + (user.bot ? `[BOT]` : ``), iconURL: user.displayAvatarURL({ dynamic:true }) })
