...
import { IUnorderedStrategy, Lexer, ArgumentStream } from '@sapphire/lexure';
...
import { Collection, ChatInputApplicationCommandData, UserApplicationCommandData, MessageApplicationCommandData, ApplicationCommandManager, ApplicationCommand, ChannelType, PermissionsBitField, Message, ChatInputCommandInteraction, ContextMenuCommandInteraction, CommandInteraction, TextBasedChannel, AutocompleteInteraction, Snowflake, PermissionResolvable, DMChannel, CategoryChannel, NewsChannel, ThreadChannel, TextChannel, StageChannel, VoiceChannel, GuildMember, Role, User, PermissionsString, Interaction, Client, ClientEvents, Events as Events$1, ClientOptions, Guild, PartialDMChannel } from 'discord.js';
